              ...
              if(!modalOpen){
                 ...
                 return (<ModalContainer>
                      <div className="container">
                        <div className="row">
                        <div id="modal" className="col-8 mx-auto col-md-6 col-lg-4 text-center text-capitalizd p-5">
                            <h5>item added to the cart</h5>
                            <img src={img} className="img-fluid" alt="product" />
                            <h5 classame="text-muted">price :$ {price}</h5>
...
#modal{background:var(--mainWhite)}
